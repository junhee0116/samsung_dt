...
FROM 'D:\sql\프로젝트\orderdetails.csv'
WITH (
    FIELDTERMINATOR = ',', 
    ROWTERMINATOR = '\r\n',
    FIRSTROW = 2
...
INSERT INTO Orders(orderNumber, orderDate, requireDate, shippedDate, status, comments, customerNumber) VALUES
