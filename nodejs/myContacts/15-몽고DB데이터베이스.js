...
// NoSQL 데이터베이스
// 1. 몽고DB: JSON 형식으로 문서에 자료를 저장하는 DB
// 2. 레디스: 키-값 형식으로 자료를 저장하는 DB, Memory-DB 기반 속도가 빨라 캐시용 DB로 사용
...
// Mongodb for VSCode
// mongodb+srv://admin:1234@junhee.fzqq1.mongodb.net/