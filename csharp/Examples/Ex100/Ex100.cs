...
namespace Examples.Ex100 {
    internal class Ex100 {
        static void Main(string[] args) {
            ...
            //} else if(D > 0) {
            //    Console.WriteLine(Math.Round((-numbers[1] + Math.Sqrt(D)) / (2 * numbers[0]), 2));
            //    Console.WriteLine(Math.Round((-numbers[1] - Math.Sqrt(D)) / (2 * numbers[0]), 2));
            //}
            ...
            //List<String> keys = new List<String>(Order.Keys);
